...
const char *zinnia_result_hz(zinnia_result_t *result, size_t i) {
    return result->ptr->hz_rec(i);
}
float zinnia_result_getx(zinnia_result_t *result, size_t i) {
    return result->ptr->getx(i);
}
float zinnia_result_gety(zinnia_result_t *result, size_t i) {
    return result->ptr->gety(i);
}
int  zinnia_result_getStorkeNum(zinnia_result_t *result, size_t i) {
    return result->ptr->getStorkeNum(i);
}
...
size_t zinnia_result_size_pairs(zinnia_result_t *result) {
    return result->ptr->size_pairs();
}
size_t zinnia_result_size_hz(zinnia_result_t *result) {
    return result->ptr->size_hz();
}
...
zinnia_result_t *zinnia_recognizer_classify2(zinnia_recognizer_t *recognizer,
                                            const zinnia_character_t *character)
                                             {
    zinnia::Result *r = recognizer->ptr->classify(*(character->ptr));
